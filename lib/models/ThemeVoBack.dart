...
class ThemeVoBack implements YunBaseModel {
  int createTime; // 0
  int id; // 0
  String name;
  String remark;
  ...
  ThemeVoBack({this.createTime, this.id, this.name, this.remark, this.tagList});

  ThemeVoBack fromJson(Map<String, dynamic> json) {
    ThemeVoBack vo = ThemeVoBack(
  ...
  factory ThemeVoBack.dto() {
    ThemeVoBack dto = ThemeVoBack();
